...
if($_SERVER["REQUEST_METHOD"]=="GET")
{
    ...
    $query="SELECT oc.id, oc.folio, c.codigo, oc.orden_compra_c, oc.fecha_orden, oc.fecha_entrega, oc.total_pares, h.precio*oc.total_pares AS precio, oc.facturaNo, oc.status, oc.remision_id, h.nombre AS horma
